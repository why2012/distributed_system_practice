...
public class AsyncReplicationOperation<
        Request extends ReplicationRequest<Request>,
        ReplicaRequest extends ReplicationRequest<ReplicaRequest>,
        PrimaryResultT extends AsyncReplicationOperation.PrimaryResult<ReplicaRequest>
        > {
    ...
    public AsyncReplicationOperation(Request request, Primary<Request, ReplicaRequest, PrimaryResultT> primary,
                                ...
                                String primaryAwarenessAttribute, String primaryAwarenessAttributeValue,
    ...
    private void buildNodeAttrMapping(ClusterState clusterState) {
        for (final ShardRouting shard : primary.getReplicationGroup().getReplicationTargets()) {
            DiscoveryNode shardNode = clusterState.nodes().get(shard.currentNodeId());
            assert shardNode != null: "Cannot find discoveryNode of shard: " + shard;
            nodeIdToAttributeValue.put(shard.currentNodeId(), shardNode.getAttributes().get(primaryAwarenessAttribute));
        }
    }
    ...
    private void markUnavailableShardsAsStale(ReplicaRequest replicaRequest, ReplicationGroup replicationGroup) {
        ...
        for (String allocationId : replicationGroup.getUnavailableInSyncShards()) {
            ...
            replicasProxy.markShardCopyAsStaleIfNeeded(replicaRequest.shardId(), allocationId, primaryTerm,
                    ActionListener.wrap(r -> decPendingAndFinishIfNeeded(), this::onNoLongerPrimary));
        }
    }
                ...
                new ActionListener<ReplicaResponse>() {
                    ...
                    public void onResponse(ReplicaResponse response) {
                        ...
                        try {
                            ...
                            decPendingAndFinishIfNeeded(shardNodeAttributeValue);
                        }
                    }
                    ...
                    public void onFailure(Exception replicaException) {
                        ...
                        replicasProxy.failShardIfNeeded(shard, primaryTerm, message, replicaException,
                                ActionListener.wrap(r -> decPendingAndFinishIfNeeded(shardNodeAttributeValue), AsyncReplicationOperation.this::onNoLongerPrimary));
                    }
