...
public class TransportAsyncShardBulkAction extends TransportAsyncWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    private static final Logger logger = LogManager.getLogger(TransportAsyncShardBulkAction.class);
    ...
    public TransportAsyncShardBulkAction(Settings settings, TransportService transportService, ClusterService clusterService,
        ...
        super(settings, ACTION_NAME, transportService, clusterService, indicesService, threadPool, shardStateAction, actionFilters,
                BulkShardRequest::new, BulkShardRequest::new, ThreadPool.Names.WRITE, false, primaryAwarenessSettingStore);
    ...
    protected BulkShardResponse newResponseInstance(StreamInput in) throws IOException {
        return ReflectionUtils.newInstance(BulkShardResponse.class, new Class[]{StreamInput.class}, new Object[]{in});
    }
    ...
    public static Translog.Location performOnReplica(BulkShardRequest request, IndexShard replica) throws Exception {
        ...
        for (int i = 0; i < request.items().length; i++) {
            ...
            final BulkItemResponse response = ReflectionUtils.invokeMethod(item, "getPrimaryResponse",
