            ...
            try {
                ...
                if (primaryShardReference.isRelocated()) {
                    ...
                    new AsyncReplicationOperation<>(primaryRequest.getRequest(), primaryShardReference,
                            ...
                            primaryAwarenessSettingStore.getPrimaryAwarenessAttributeValue(), clusterService).execute();
                }
            } catch (Exception e) {
        ...
        protected void doRun() {
            ...
            if (blockException != null) {
                ...
                if (indexMetaData == null) {
                    ...
                    long routedBasedOnClusterVersion = request.routedBasedOnClusterVersion();
